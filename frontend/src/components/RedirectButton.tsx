...
<p className="hidden sm:block text-green-600 text-2xl font-semibold">Find a ride</p>
</div>
<div className="text-center border-green-100 border-2 py-10 w-1/3 px-20 rounded-2xl">
<div className="sm:hidden text-green-600 text-3xl">
        <FaCar />
      </div>
<p className="hidden sm:block text-green-600 text-2xl font-semibold">Start A ride</p>
</div>
<div className="text-center border-green-100 border-2 w-1/3 py-10 px-20 rounded-2xl">
<div className="sm:hidden text-green-600 text-3xl">
        <FaMoneyBillWave />
      </div>
<p className="hidden sm:block text-green-600 text-2xl font-semibold">Earn with us</p>
</div>
</div>
</div>
  )
